...
_G.packer_plugins = {
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/luis/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
    url = "https://github.com/inkarkat/vim-ReplaceWithRegister"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/vim-maximizer",
